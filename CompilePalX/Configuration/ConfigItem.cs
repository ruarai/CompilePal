    ...
    public class ConfigItem : ICloneable
    {
        ...
        public object Clone()
        {
            return new ConfigItem
            {
                ...
                Warning = Warning,
                CanBeUsedMoreThanOnce = CanBeUsedMoreThanOnce,
                ReadOutput = ReadOutput,
                ValueIsFile = ValueIsFile,
                Value2IsFile = Value2IsFile,
                ValueIsFolder = ValueIsFolder,
                Value2IsFolder = Value2IsFolder,
                WaitForExit = WaitForExit,
                CompatibleGames = CompatibleGames,
                IncompatibleGames = IncompatibleGames
            };
        }
    }
}
